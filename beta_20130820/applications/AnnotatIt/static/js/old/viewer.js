var VIEWER_current_time = 0;
var VIEWER_video_duration = 0;
var VIEWER_video_player = null;
...
function setVideoTimeFromString(time, setTimeCallback){
...
function setVideoTimeFromNumber(time, setTimeCallback){
    //console.log("setting time");    
    //console.log(time);
    setTimeCallback(ntime);
}
...
function annotation_submit(){
    ...
    ntime=VIEWER_current_time + time_delay;
    if (ntime<0){
        ntime = 0;
    }
...
function canvas_draw_tag( tag_json, imgs_path ){
    ...
    var img_src="QUESTION_icon_20px.png";
...
function get_tags(video_id, url_call){
