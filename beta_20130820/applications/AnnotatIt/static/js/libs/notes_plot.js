    ...
    */
    ...
    AnnotatIt.CommentsPlot = (function ($ ) {
            ...
            getBeginTime = function(data,index){
                console.log("getting begin time");
                console.log(data);
            ...
            getCenterX = function(data,index){
                ...
                //console.log(cx);
                //return xScale(cx);
                return xScale(data.get("begin_time"));
            };
            ...
            return {
                ...
                //updates data to redraw
                //erases data that is not longer available
                updateAll : function(arrData){
                    console.log("updateAll");
                    //////////////////////////////////////////////////////
                    //Comments (Notes that have equal init and end time)
                    //////////////////////////////////////////////////////
                    commentsData = notes.selectAll("circle")
                                            .data(arrData, getKey);
                    console.log("commentsData = ");
                    console.log(commentsData);
                    commentsData = commentsData.enter().filter(function(d,i){
                                                console.log("filtering");
                                                console.log(d[i]);
                                                console.log((getBeginTime(d[i]) ));
                                                console.log("get end time filtering");
                                                console.log((getEndTime(d) ));
                                                console.log("compare filtering");
                                                console.log((getBeginTime(d) == getEndTime(d) ));
                                                console.log("end filtering");
                                                //return  (getBeginTime(d) == getEndTime(d) );
                                                return true;
                                            });
                    console.log("filtered commentsData = ");
                    console.log(commentsData);
                    commentsData.exit().remove();
                    //////////////////////////////////////////////////////
                    //Sections (Notes that have a duration
                    //////////////////////////////////////////////////////
                    sectionsData = comments.selectAll("rect")
                                            .data(arrData, getKey);
                    sectionsData = sectionsData.enter()
                                            .filter(function(d,i){
                                                return  (getBeginTime(d) != getEndTime(d));
                                            });
                    sectionsData.exit().remove();
                },
                ...
                init : function(w, h, d){
                    ...
                    */
                    ...
                    notes = paper.append('g').attr("class","notes");
                    comments = notes.append('g').attr("class","comments");
                    sections = notes.append('g').attr("class","sections");
                    ...
                    $(document).on("Annotatit:Event:Note:update", this ,this.updateFromCollection);
                    initialized = true;
                    self = this;
                    return this;
                }, //./init
