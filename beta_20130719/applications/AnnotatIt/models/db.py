...
db.define_table('media', 
    ...
    Field('annotation_permissions', default='only_me', requires=IS_IN_SET(("only_me", "authorized_groups", "all"))), 
    Field('view_permissions', default='only_me', requires=IS_IN_SET(("only_me", "authorized_groups",  "all"))),
